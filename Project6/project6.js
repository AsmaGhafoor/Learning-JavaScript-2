...
// // Intialize the number of parameters
...
//                     <div class="col-md-4">
//                         <input type="text" class="form-control" id="parameterKey${addedParamsCount+2}" placeholder="Enter Parameter 1 Key">
//                     </div>
//                     <div class="col-md-4">
//                         <input type="text" class="form-control" id="parameterValue${addedParamsCount+2}" placeholder="Enter Parameter 1 Value">
//                     </div>
...
//     // show waiting in responce box
//     document.getElementById('responceJsonText').value="Kindly wait";
